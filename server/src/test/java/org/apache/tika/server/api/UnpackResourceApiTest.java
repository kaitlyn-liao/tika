 ...
 */
public class UnpackResourceApiTest extends CXFTestBase{
    ...
    protected void setUpResources(JAXRSServerFactoryBean sf) {
        sf.setResourceClasses(UnpackResourceApiServiceImpl.class);
        sf.setResourceProvider(UnpackResourceApiServiceImpl.class,
                new SingletonResourceProvider(new UnpackResourceApiServiceImpl()));
    }
