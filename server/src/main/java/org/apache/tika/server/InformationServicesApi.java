...
public interface InformationServicesApi  {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "If successful, this operation returns HTTP status code 200, with the body containing a list of endpoints.", response = Object.class, responseContainer = "List"),
        @ApiResponse(code = 500, message = "An error occurred processing the call.") })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "If successful, this operation returns HTTP status code 200, with the body containing Mime types, their aliases, their supertype, and the parser.", response = Object.class, responseContainer = "List"),
        @ApiResponse(code = 500, message = "An error occurred processing the call.") })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "If successful, this operation returns HTTP status code 200, with the body containing a list of parser objects.", response = ParsersORParsersDetails.class),
        @ApiResponse(code = 500, message = "An error occurred processing the call.") })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "If successful, this operation returns HTTP status code 200, with the body containing a list of parser object details including the mime types handled by each parser.", response = ParsersORParsersDetails.class),
        @ApiResponse(code = 500, message = "An error occurred processing the call.") })
